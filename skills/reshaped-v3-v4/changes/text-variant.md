...
- Variant property might also be responsive, with an object of values which have to be migrated as well.
  Syntax example: `<Text variant={{ s: "body-3", m: "featured-4" }} />`

- `title-4`, `title-5`, `title-6` map to `featured-1`, `featured-2`, `featured-3` respectively, but also require adding `weight` from the main theme definition.

Before: `<Text variant="body-3" />`
After: `<Text variant="body-2" />`

Before: `<Text variant="title-4" />`
After: `<Text variant="featured-1" weight="semibold" />`
