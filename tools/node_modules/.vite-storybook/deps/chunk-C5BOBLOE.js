...
var checkMethod = function checkMethod2(method, deprecationWarning) {
  ...
  if ((_global$FEATURES = import_global2.default.FEATURES) !== null && _global$FEATURES !== void 0 && _global$FEATURES.storyStoreV7) {
    throw new Error((0, import_ts_dedent2.default)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral2(["You cannot use `", "` with the new Story Store.\n      \n      ", ""], ["You cannot use \\`", "\\` with the new Story Store.\n      \n      ", ""])), method, warningAlternatives[method]));
  }
  if (!singleton) {
...
var ClientApi = function() {
  function ClientApi2() {
    ...
    }, (0, import_ts_dedent2.default)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral2(["\n      `setAddon` is deprecated and will be removed in Storybook 7.0.\n\n      https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#deprecated-setaddon\n    "], ["\n      \\`setAddon\\` is deprecated and will be removed in Storybook 7.0.\n\n      https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#deprecated-setaddon\n    "]))));
    ...
    }, (0, import_ts_dedent2.default)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral2(["\n      `clearDecorators` is deprecated and will be removed in Storybook 7.0.\n\n      https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#deprecated-cleardecorators\n    "], ["\n      \\`clearDecorators\\` is deprecated and will be removed in Storybook 7.0.\n\n      https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#deprecated-cleardecorators\n    "]))));
...
//# sourceMappingURL=chunk-C5BOBLOE.js.map
