import {
  init_es_array_join
} from "./chunk-QNUMIVAH.js";
import {
  require_slash
} from "./chunk-7P2GAL6R.js";
import {
  require_stable
} from "./chunk-TYRZDJHE.js";
import {
  require_synchronous_promise
} from "./chunk-N6AD4MUO.js";
import {
  require_runtime
} from "./chunk-T4WCKULT.js";
import {
  require_mapValues
} from "./chunk-3JSL64ND.js";
import {
  require_pick
} from "./chunk-W3PGWV4L.js";
import {
  require_pickBy
} from "./chunk-5C3C2HL6.js";
import {
  require_isPlainObject
} from "./chunk-HGRFRAD5.js";
import {
  require_dist as require_dist2
} from "./chunk-GHBU6TYU.js";
import {
  HooksContext,
  addons,
  applyHooks,
  ...
  useMemo,
  useState
} from "./chunk-ZLYSAJBM.js";
import {
  require_string_trim,
  require_whitespaces
} from "./chunk-P3KOINJL.js";
import {
...
// ../../node_modules/@storybook/store/node_modules/fast-deep-equal/index.js
var require_fast_deep_equal = __commonJS({
  "../../node_modules/@storybook/store/node_modules/fast-deep-equal/index.js"(exports, module) {
    "use strict";
...
init_es_array_concat();
init_es_object_assign();
var import_csf = __toESM(require_dist2());
var import_ts_dedent2 = __toESM(require_dist());
init_esm();
...
var deprecatedStoryAnnotation = (0, import_ts_dedent2.default)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral2(["\nCSF .story annotations deprecated; annotate story functions directly:\n- StoryFn.story.name => StoryFn.storyName\n- StoryFn.story.(parameters|decorators) => StoryFn.(parameters|decorators)\nSee https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#hoisted-csf-annotations for details and codemod.\n"])));
...
init_es_object_assign();
var import_csf2 = __toESM(require_dist2());
...
init_web_dom_collections_for_each();
init_es_object_keys();
var import_csf3 = __toESM(require_dist2());
init_esm();
...
fixRegExpWellKnownSymbolLogic("match", 1, function(MATCH2, nativeMatch, maybeCallNative) {
  return [
    function match(regexp) {
      ...
      var matcher = regexp == void 0 ? void 0 : regexp[MATCH2];
      return matcher !== void 0 ? matcher.call(regexp, O) : new RegExp(regexp)[MATCH2](String(O));
    },
    function(regexp) {
...
init_es_object_to_string();
var import_es_set = __toESM(require_es_set());
...
var import_ts_dedent4 = __toESM(require_dist());
init_esm();
...
init_es_object_to_string();
init_es_object_entries();
var import_csf5 = __toESM(require_dist2());
...
init_es_object_freeze();
var import_ts_dedent5 = __toESM(require_dist());
...
var StoryIndexStore = function() {
  ...
  _createClass(StoryIndexStore2, [{
    ...
    value: function storyIdToEntry(storyId) {
      ...
      if (!storyEntry) {
        throw new Error((0, import_ts_dedent5.default)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral5(["Couldn't find story matching '", "' after HMR.\n      - Did you remove it from your CSF file?\n      - Are you sure a story with that id exists?\n      - Please check your stories field of your main.js config.\n      - Also check the browser console and terminal for error messages."])), storyId));
      }
      return storyEntry;
    }
  }]);
...
init_es_object_to_string();
var import_es_set2 = __toESM(require_es_set());
...
var import_ts_dedent6 = __toESM(require_dist());
...
var FORCED2 = DESCRIPTORS && isForced("RegExp", !CORRECT_NEW || UNSUPPORTED_Y || fails2(function() {
  re2[MATCH] = false;
...
var SUPPORTS_Y = !fails3(function() {
  ...
  return [
    ...
    function(regexp, limit) {
      ...
      while (q < S.length) {
        ...
        var e;
        if (z === null || (e = min(toLength2(splitter.lastIndex + (SUPPORTS_Y ? 0 : q)), S.length)) === p) {
...
var import_ts_dedent7 = __toESM(require_dist());
init_esm();
...
var userOrAutoTitleFromSpecifier = function userOrAutoTitleFromSpecifier2(fileName, entry, userTitle) {
  ...
  if (typeof fileName === "number") {
    once.warn((0, import_ts_dedent7.default)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral7(['\n      CSF Auto-title received a numeric fileName. This typically happens when\n      webpack is mis-configured in production mode. To force webpack to produce\n      filenames, set optimization.moduleIds = "named" in your webpack config.\n    ']))));
  }
...
var import_ts_dedent8 = __toESM(require_dist());
...
var sortStoriesV7 = function sortStoriesV72(stories, storySortParameter, fileNameOrder) {
  try {
    ...
    throw new Error((0, import_ts_dedent8.default)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral8(["\n    Error sorting stories with sort parameter ", ":\n\n    > ", "\n    \n    Are you using a V6-style sort function in V7 mode?\n\n    More info: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#v7-style-story-sort\n  "])), storySortParameter, err.message));
  }
};
...
//# sourceMappingURL=chunk-6BQHV6VP.js.map
