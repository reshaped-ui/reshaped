  ...
  "node_modules/json5/dist/index.js"(exports, module) {
    !function(u, D) {
      ...
      return { parse: function(u2, D2) {
        ...
        var e2 = [], C2 = "", A2 = void 0, E2 = void 0, n2 = "", o2 = void 0;
        ...
        function v2(u3, D3) {
          ...
          return "string" == typeof F3 ? m2(F3) : "number" == typeof F3 ? String(F3) : "object" === (void 0 === F3 ? "undefined" : i(F3)) ? Array.isArray(F3) ? function(u4) {
            ...
            var D4 = C2;
            C2 += n2;
            var F4 = A2 || Object.keys(u4), r2 = [], t2 = true, E3 = false, i2 = void 0;
            try {
              for (var o3, a3 = F4[Symbol.iterator](); !(t2 = (o3 = a3.next()).done); t2 = true) {
        ...
        function m2(u3) {
          ...
          try {
            for (var t2, E3 = u3[Symbol.iterator](); !(C3 = (t2 = E3.next()).done); C3 = true) {
              var n3 = t2.value;
              switch (n3) {
                case "'":
                case '"':
        ...
        function p2(u3) {
          ...
          for (var F3 = D3.length; F3 < u3.length; F3++)
            if (!t(String.fromCodePoint(u3.codePointAt(F3))))
              return m2(u3);
          return u3;
        }
      } };
