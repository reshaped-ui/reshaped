...
export const trigger = () => {
	return (
		<Example>
			...
			<Example.Item title="native with options tags">
				<Select name="animal">
			...
			<Example.Item title="native with custom trigger">
				<Select name="animal" onClick={() => console.log("clicked")}>
					Hello
				</Select>
			</Example.Item>

			<Example.Item title="custom">
