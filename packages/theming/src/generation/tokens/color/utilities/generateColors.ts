...
const generateColorValues = (
	...
	const bgHighlighted = adjustLightnessByForegroundDirection(bg, fgLightness, 0.1);
	const bgHighlightedDark = adjustLightnessByForegroundDirection(bgDark, fgDarkLightness, 0.1);
