...
const theme: Partial<ThemeDefinition> = {
	...
	color: {
		...
		backgroundNeutralHighlighted: { hex: "#C8CED9", hexDark: "#4D4D4D" },
		...
		backgroundPrimaryHighlighted: { hex: "#39ADFF", hexDark: "#39A2F2" },
		...
		backgroundPositiveHighlighted: { hex: "#79D297", hexDark: "#76C28B" },
		...
		backgroundCriticalHighlighted: { hex: "#FCA397", hexDark: "#F8978B" },
		...
		backgroundWarningHighlighted: { hex: "#B4920A", hexDark: "#A98909" },
