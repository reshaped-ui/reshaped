...
export const scrollbarDisplay = {
	...
	render: () => (
		<Example>
			...
			<Example.Item title="scrollbarDisplay: scroll">
				<ScrollArea height="100px" scrollbarDisplay="scroll">
					<View backgroundColor="neutral-faded" padding={4} width="150%">
						Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
						has been the industry's standard dummy text ever since the 1500s, when an unknown
						printer took a galley of type and scrambled it to make a type specimen book. It has
	...
	render: () => {
		...
		return (
			<Example>
				...
				<Example.Item title="inside a card with rounded corners">
					<Card padding={0} height="120px">
						<ScrollArea scrollbarDisplay="visible">
							<View padding={4}>
